...
class TestMCPSystemIntegration:
    ...
    async def discovery_service(self):
        ...
        config = ToolDiscoveryConfig(discovery_interval=1, max_tools_per_source=100)
    ...
    async def test_adapter_registration_and_discovery(
        self, discovery_service, erp_adapter, wms_adapter, iot_adapter
    ):
    ...
    async def test_service_registry_integration(
    ...
    async def test_tool_execution_workflow(
        ...
        decision = await routing_service.route_tools(
            context, strategy=RoutingStrategy.BALANCED, max_tools=5
        )
    ...
    async def test_agent_integration_workflow(
        self, all_agents, discovery_service, erp_adapter, wms_adapter, iot_adapter
    ):
    ...
    async def test_monitoring_integration(
        self, monitoring_service, mcp_server, mcp_client, discovery_service
    ):
        ...
        ), "Dashboard should include healthy services count"
