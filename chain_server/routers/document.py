...
async def process_document_background(
    ...
    try:
        ...
        from chain_server.agents.document.preprocessing.nemo_retriever import (
            NeMoRetrieverPreprocessor,
        )
        from chain_server.agents.document.ocr.nemo_ocr import NeMoOCRService
        from chain_server.agents.document.processing.small_llm_processor import (
            SmallLLMProcessor,
        )
        from chain_server.agents.document.validation.large_llm_judge import (
            LargeLLMJudge,
        )
        from chain_server.agents.document.routing.intelligent_router import (
            IntelligentRouter,
        )
